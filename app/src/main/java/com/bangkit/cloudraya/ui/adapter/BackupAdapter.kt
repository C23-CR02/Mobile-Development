...
class BackupAdapter(private val onDeleteClick: (SnapshotsItem) -> Unit, private val onRestoreClick: (SnapshotsItem) -> Unit): RecyclerView.Adapter<BackupAdapter.MyViewHolder>() {
